...
class CategoryProvider extends ChangeNotifier {
  ...
  // AsyncValue<List<ProductDetailModel>> get productsByCategory =>
  //     _productsByCategory;
  ...
  Future<void> fetchProductsBySubCategory(String subCategoryId) async {
    ...
    try {
      ...
      print(
          'DEBUG: Fetched ${products.length} products for subcategory $subCategoryId');
      print('DEBUG: Product IDs: ${products.map((p) => p.productId).toList()}');
      notifyListeners();
    } catch (e) {
